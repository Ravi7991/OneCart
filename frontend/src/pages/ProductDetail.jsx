...
function ProductDetail() {
  ...
  return productData ? (
    <div className='flex flex-col gap-0 overflow-x-hidden'>
      <div className='w-[99vw] min-h-fit bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col lg:flex-row gap-[20px] px-[10px] md:px-[30px] pt-[80px] pb-[30px]'>
        <div className='lg:w-[50vw] md:w-[90vw] lg:h-[80vh] h-[45vh] flex items-center justify-center md:gap-[10px] gap-[20px] flex-col-reverse lg:flex-row'>
          <div className='lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center justify-center gap-[20px] lg:gap-[20px] lg:flex-col flex-wrap '>
        ...
        <div className='lg:w-[50vw] w-[100vw] h-auto flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[15px]'>
          ...
          <div className='flex flex-col gap-[10px] my-[10px]'>
            ...
            <button className='text-[16px] active:bg-slate-500 cursor-pointer bg-[#495b61c9] py-[10px] px-[20px] rounded-2xl mt-[10px] border-[1px] border-[#80808049] text-white shadow-md shadow-black w-[200px]' onClick={()=>addtoCart(productData._id , size)} >{loading? <Loading/> : "Add to Cart"}</button>
          </div>
      ...
      <div className='w-[100%] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-x-hidden px-[20px] md:px-[50px] lg:px-[100px] gap-[20px] py-[30px]'>
        <div className='flex'>
        ...
        <div className='w-[100%] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] py-[20px]'>
