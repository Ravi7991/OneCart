...
function OurPolicy() {
  return (
    <div className='w-[100vw] min-h-[50vh] flex items-center justify-start flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[30px] py-[50px] '>
      ...
      <div className='w-[100%] flex items-center justify-center flex-wrap lg:gap-[50px] gap-[40px] mt-[20px]'>
