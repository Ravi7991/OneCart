...
function NewLetterBox() {
  ...
  return (
    <div className='w-[100%] min-h-[40vh] py-[50px] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center gap-[20px] flex-col'>
      ...
      <form action="" onSubmit={handleSubmit} className='w-[100%] flex items-center justify-center gap-[20px] px-[20px]'>
